...
const ZONES: Zone[] = [
  ...
  {
    title: "สมาชิก / บริการ",
    body: "ค่าสมาชิกรายเดือนอย่าง Netflix ตั้งไว้ว่าตัดเงินวันไหน เปิด/ปิดได้ พอถึงเดือนมันโผล่ในรายการจ่ายให้เอง ไม่ลืมว่าจ่ายอะไรอยู่",
    tags: ["ตัดเงินทุกวันที่ 29", "เปิด/ปิดบริการ"],
    iconBg: "#EFEAFB",
    iconColor: "#7C5CE0",
    icon: (
      <path
        d="M4 9a8 8 0 0 1 14-4M20 5v4h-4M20 15a8 8 0 0 1-14 4M4 19v-4h4"
        strokeLinecap="round"
