...
export const metadata = {
  title: "Debt Tracker — หนี้ ผ่อน บัตร ซับ รู้หมดในที่เดียว",
  description:
    "แอปคุมหนี้/รายจ่ายส่วนตัว ใช้เอง 100% เปิดให้เพื่อนลอง — ค่าใช้จ่ายประจำ ยอดผ่อน บิลบัตรเครดิต ค่าสมาชิกรายเดือน รวมไว้ที่เดียว",
};
